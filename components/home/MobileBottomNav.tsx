    ...
    >
      <div
        className={cn(
          ...
          "before:bg-linear-to-r before:from-transparent before:via-kinetic/50 before:to-transparent",
        )}
      >
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                "focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-kinetic",
                isActive
            ...
            >
              <Icon
                className={cn(
                  "size-5 shrink-0",
                  isActive ? "text-kinetic-dark" : "text-white/50",
                )}
                aria-hidden="true"
              ...
              <span
                className={cn(
                  ...
                  isActive ? "text-kinetic-dark" : "text-current",
                )}
              >
                {tab.label}
              </span>
