    ...
    <main className="relative flex min-h-svh items-center justify-center overflow-hidden bg-kinetic-surface px-4  text-kinetic-on-surface antialiased">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="mb-12 flex flex-col items-center text-center">
          <div className="clip-retro mb-6 flex size-16 items-center justify-center border border-white/60 bg-kinetic-surface-container shadow-[0_0_20px_rgba(211,237,134,0.1)]">
            <Shield
              className="size-8 text-kinetic-primary-container"
              aria-hidden="true"
            />
          </div>
